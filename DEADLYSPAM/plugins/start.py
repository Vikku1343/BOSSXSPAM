...
if config.ALIVE_PIC:
    ...
    DEADLY_IMG = "https://telegra.ph/file/7cfd0497ba8d70d27cd29.jpg"
...
Deadly_Button = [
        [
        Button.url("Cʜᴀɴɴᴇʟ", "https://t.me/Moment_Hai_Vaaii"),
        Button.url("Sᴜᴘᴘᴏʀᴛ", "https://t.me/TheImaginationWorld")
        ],
        [
        Button.url("• Rᴇᴘᴏ •", "https://t.me/Dilll_se")
        ]
        ]
...
async def start(e):
    if e.chat_id is e.sender_id:
        ...
        creator = f"[『♧ 𝐁 𝐨 𝐬 𝐬 ♧』| ͢♧ 𝐁 𝐨 𝐬 𝐬 ♧](tg://user?id={7001790295})"
        DEADLY_ON = f"""
ʜᴇʏ {mention},
ᴛʜɪs ɪs вσѕѕ χ вσтѕ ᴘᴏᴡᴇʀᴇᴅ ʙʏ:- {creator}!
