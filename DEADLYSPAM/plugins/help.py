...
HELP_PIC = "https://telegra.ph/file/f6c924a91266c05bc74b4.jpg"

DEAD_HELP = "🔥 вσѕѕ χ вσтѕ🔥\n\n"
...
DEAD_HELP += f"© @TheImaginationWorld\n"


@BOT0.on(events.NewMessage(incoming=True, pattern='/help'))
async def help(event):               
    if event.sender_id in SUDOERS:
       blaze = [[Button.url("ᴄʜᴀɴɴᴇʟ", "https://t.me/Moment_Hai_Vaaii"), Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/TheImaginationWorld")]]
